...
class CreateStructureForLocalisation extends StructureMigration
{
    ...
    protected $permissions = [
        ...
        ['name' => 'system.localisation.addLangKey', 'description' => 'Add new lang key', 'type' => 1, 'default' => false],
    ...
    protected $menu = [
        'name' => 'Localisation', 'icon' => 'language', 'link' => 'system.localisation.index', 'has_children' => false,
    ];
