...
class CreateStructureForLocalisation extends StructureMigration
{
    ...
    protected $permissions = [
        ...
        ['name' => 'system.localisation.editTexts', 'description' => 'Edit Language File', 'type' => 1, 'default' => false],
        ...
        ['name' => 'system.localisation.saveLangFile', 'description' => 'Save Lang File', 'type' => 1, 'default' => false],
        ['name' => 'system.localisation.store', 'description' => 'Save Language', 'type' => 1, 'default' => false],
